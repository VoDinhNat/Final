...
const createOrder = async (req, res) => {
    try {
        ...
        const create_payment_json = {
            ...
            redirect_urls: {
                return_url: "https://final-3fhba0wg2-vonhat570-4496s-projects.vercel.app/shop/paypal-return",
                cancel_url: "https://final-3fhba0wg2-vonhat570-4496s-projects.vercel.app/shop/paypal-cancel",
            },
            transactions: [
                {
                    item_list: {
